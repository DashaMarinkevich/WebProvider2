    ...
    <body>
        ...
        <div id="leftcontent">
            <div class="curvebox3">
                ...
                <div id="menu">
                    <h2>
                        <a href="#">Удаление тарифного плана</a>
                    </h2>
                    ...
                    <table>
                        ...
                        <tr>
                            <td><button style=" background: #F5F5F5; color: black; width: 157px" type="submit" value='deleteTarif'
                                        name='command'>Удалить тарифный план</button></td>
