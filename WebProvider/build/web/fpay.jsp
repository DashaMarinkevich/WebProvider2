    ...
    <body >
        ...
        <div id="leftcontent">
            <div class="curvebox3">
                ...
                <div id="menu">
                    <h2>
                        <a href="#">Оформить обещанный платеж</a>
                    </h2>
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input type="sumPay" name='sumPay' pattern="\-?\d+(\.\d{0,})?"  title="Вводите только цифры!"
                        ...
                        <tr>
                            <td><input type="datePays" name='datePays'
                        ...
                        <tr>
                            <td><button style=" background: #F5F5F5; color: black;" type="submit" value='addFuturePay'
                                        name='command'><FONT face="Comic Sans MS">Оплатить</font></button></td>
                        <a href="service.jsp">Назад</a></td>
                        </tr>
        ...
        <div id="rightcontent">
            <img src="images/fpay.jpg" height="500px"/>  
        </div>
