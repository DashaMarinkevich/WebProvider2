        ...
        <div id="leftcontent">
            <div class="curvebox3">
                ...
                <div id="menu">
                    ...
                    <table>
                        <tr>
                            <td style="  color:  #000000;">Введите название  услуги</td>
                        </tr>
                        <tr>
                            <td><input type='nameService' name='nameService' pattern="[а-яА-ЯёЁ\s]+$"  title="Вводите только русские слова!"size='20'
                                       required="required" /></td>
                        </tr>


                        <tr>
                            <td><button style=" background: #F5F5F5; color: black; width: 157px" type="submit" value='deleteService'
                                        name='command'>Удалить услугу</button></td>
