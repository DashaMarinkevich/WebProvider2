...
<html>
    ...
    <body >
            ...
            <div class="curvebox3">
                ...
                <div id="menu">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><input type="numPersonalAccount"  pattern="\-?\d+(\.\d{0,})?" name='numPersonalAccount'  title="Вводите только цифры!" size='20'
                        ...
                        <tr>
                            <td><button style=" background: #F5F5F5; color: black;" type="submit" value='pays'
        ...
        <div id="rightcontent">
            <img src="images/pays.jpg" height="500px"/>  
        </div>
